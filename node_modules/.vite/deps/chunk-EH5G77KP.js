...
var require_jsonwebtoken = __commonJS({
  "browser-external:jsonwebtoken"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "jsonwebtoken" has been externalized for browser compatibility. Cannot access "jsonwebtoken.${key}" in client code. See http://vitejs.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
reconnecting-websocket/dist/reconnecting-websocket-mjs.js:
  ...
  ***************************************************************************** *)
   ...
   *)
*/
//# sourceMappingURL=chunk-EH5G77KP.js.map
